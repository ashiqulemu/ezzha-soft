<footer class="pb-4">
    <div class="footer-col">
        <div class="items">
            ...
            <a href="./crm-easy.html">CRM Easy</a>
            ...
            <a href="./e-pos.html">EPOS</a> 
        </div>
        <div class="items">
            <div class="heading">Solutions</div>
            <a href="./search-social-ads.html">Search / Social Ads</a>
            <a href="./e-commerce.html">eCommerce</a>
            <a href="./web-design.html"> Web Design </a>
            <a href="./software-development.html">Software Development</a>
            <a href="./apps.html">Apps</a>

            <a href="data-center-solution.html">Data Centre Solutions and Decommissioning</a>
        </div>
        <div class="items">
            <div class="heading">Industries</div>
            <a href="./education.html">Education</a>
            <a href="./local-agency.html">Local Agencies</a>
        ...
        <div class="items">
            ...
            <a href="./overview.html" class="footer_link w--current">Overview</a>
            <a href="./customer-stories.html">Customer Stories</a>
        </div>
        <div class="items">
            <div class="heading">Privacy</div>
            <a href="./privacy-policy.html">Privacy Central</a> 
            <a href="./cookie.html">Cookie Management</a> 
    ...
    <div class="container mx-auto text-white">
        <div class="row mx-auto border rounded w-100 py-2">
            ...
            d-flex align-items-center justify-content-center">
                <a href="contact.html" class="nav-btn text-capitalize">contact us</a>
            </div>
        </div>
